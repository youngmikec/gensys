...
import { ApiResponse, Giftcard } from '../../../model';
import GiftcardUpdateForm from './giftcard-update-form';
import { CloseAppModal, OpenAppModal } from '../../../store/modal';
import { DELETE_GIFTCARD, RETRIEVE_GIFTCARDS } from '../../../services';
import { INITIALIZE_GIFTCARDS, REMOVE_GIFTCARD } from '../../../store/giftcards';
                        ...
                        <div className="overflow-x-scroll p-4">
                            <table className="table table-auto w-full mx-auto border-spacing-y-4">
                                ...
                                {   giftcards.length > 0 ?
                                    ...
                                    <tr>
                                    <td colSpan={5} className="text-center py-3">No Giftcard Record available</td>
                                    </tr>
                                }
                                </tbody>
                            </table>
